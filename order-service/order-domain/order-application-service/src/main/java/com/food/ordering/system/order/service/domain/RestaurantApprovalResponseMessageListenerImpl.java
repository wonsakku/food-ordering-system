...
import com.food.ordering.system.order.service.domain.ports.input.massage.listener.restaurantapproval.RestaurantApprovalResponseMessageListener;
...
public class RestaurantApprovalResponseMessageListenerImpl implements RestaurantApprovalResponseMessageListener {
    ...
    public void orderRejected(RestaurantApprovalResponse restaurantApprovalResponse) {
        ...
        log.info("Publishing order cancelled event for order id : {} with failure messasges: {}",
