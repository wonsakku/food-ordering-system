...
public class OrderDataMapper {
    ...
    public Order createOrderComfmandToOrder(CreateOrderCommand createOrderCommand){
    ...
    private List<OrderItem> orderItemsToOrderItemEntity(@NotNull List<com.food.ordering.system.order.service.domain.dto.create.OrderItem> orderItems) {
